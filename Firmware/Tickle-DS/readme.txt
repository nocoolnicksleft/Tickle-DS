========================================================================
    MAKEFILE-PROJEKT: Tickle-DS-Projektübersicht
========================================================================

Dieses Tickle-DS-Projekt wurde vom Anwendungs-Assistenten für Sie erstellt. 
...
Mit diesem Projekt können Sie durch Aufrufen der im Assistenten eingegebenen Befehle aus Visual Studio heraus erstellen/bereinigen/neu erstellen. Als Erstellungsbefehl kann nmake oder ein anderes Tool Ihrer Wahl verwendet werden.

Da dieses Projekt keine Dateien enthält, werden im Projektmappen-Explorer keine Dateien angezeigt.
